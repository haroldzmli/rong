  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="CreateTime" prop="timestamp">
...
<script>
import { getUserMapData } from '@/api/user-map-data'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getUserMapData(this.listQuery).then(response => {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['timestamp', 'title11', 'type', 'importance', 'status']
        const filterVal = ['timestamp', 'title11', 'type', 'importance', 'status']
